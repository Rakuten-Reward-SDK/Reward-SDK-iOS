Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/Rakuten-Reward-SDK/Reward-SDK-iOS/releases/download/7.0.6/RakutenRewardSDK-7.0.6-b2-Release-XC11E801a.zip' }
