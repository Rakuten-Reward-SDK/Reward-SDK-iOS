Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/Rakuten-Reward-SDK/Reward-SDK-iOS/releases/download/7.0.3/RakutenRewardSDK-7.0.3-6.xcframework.zip' }
