Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/Rakuten-Reward-SDK/Reward-SDK-iOS/releases/download/8.0.2/RakutenRewardSDK-8.0.2-b2.xcframework.zip' }
