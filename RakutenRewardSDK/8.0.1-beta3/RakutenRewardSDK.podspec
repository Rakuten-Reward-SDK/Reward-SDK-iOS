Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :http => 'https://github.com/Rakuten-Reward-SDK/Reward-SDK-iOS/releases/download/8.0.1/RakutenRewardSDK-8.0.1-3.xcframework.zip' }
